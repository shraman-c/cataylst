        ...
        >
          ...
          <div className="flex flex-col gap-4">
            ...
            <button
              ...
              className="w-full px-6 py-3 rounded-xl text-lg font-semibold bg-muted text-white shadow hover:bg-primary transition-all
              border border-solid border-primary/20 hover:text-muted"
            >
              Student Login
            </button>
